...
!function(){
	var bP={};	
	var b=30, bb=400, height=600, buffMargin=10, minHeight=14;
	var c1=[-190, 170], c2=[-20, 100], c3=[-65, 145]; //Column positions of labels.
	var colors =["#009EE2","#F67B1D","#4EBA31","#BD038C","#323232","#2A83AA"];
	...
	function drawHeader(header, id){
		d3.select("#"+id).append("g").attr("class","header").append("text").text(header[2])
			.style("font-size","30px").attr("x",225).attr("y",-20)
		...
		[0,1].forEach(function(d){
			...
			h.append("text").text("Count").attr("x", (c2[d]-50))
				.attr("y", -5)
				.style("fill","black")
				.style("font-size","25px");;
